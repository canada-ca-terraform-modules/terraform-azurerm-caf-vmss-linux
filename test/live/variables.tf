variable "env" {
  description = "Environment prefix used in the generated VMSS name"
  type        = string
  default     = "livetest"
}
...
variable "repository" {
  ...
  type        = string
  default     = "canada-ca-terraform-modules/terraform-azurerm-caf-vmss-linux"
}

variable "vmss" {
  description = "VMSS configuration object, passed straight through to the module under test"
  type        = any
}
